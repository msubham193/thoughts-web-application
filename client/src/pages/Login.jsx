...
import { selectStatus, userAdd } from "../redux/features/userSlice";
...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      console.log(data)
      dispatch(userAdd({ user: data.user, post: data.post }));

      toast.success("Login Success", styles);
    } catch (error) {
      console.log();
      toast.error(error.response.data.message, styles);
    }
  };
